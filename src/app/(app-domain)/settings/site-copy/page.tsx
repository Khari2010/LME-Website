...
export default function SiteCopyPage() {
  ...
  return (
    <div className="text-text-primary max-w-4xl space-y-6">
      <header>
      ...
      <section className="bg-bg-surface border border-border-crm rounded-xl p-5 space-y-3">
        ...
        {adding && (
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full bg-bg-base border border-border-crm text-text-primary px-3 py-2 rounded text-sm min-h-[80px] focus:border-accent focus:outline-none"
            />
            <button
              type="button"
              onClick={handleAdd}
              disabled={!newKey.trim()}
              className="bg-accent-hover text-bg-base uppercase tracking-wider font-bold text-sm px-5 py-2 rounded hover:bg-accent disabled:opacity-40"
            >
              Save
            </button>
          </div>
...
function CopyRow({
  ...
  return (
    <div className="bg-bg-surface border border-border-crm rounded-xl p-4 space-y-2">
      <div className="flex items-center justify-between">
        <code className="text-xs text-accent font-mono">{row.key}</code>
      ...
      <div className="flex gap-2">
        <button
          ...
          className="bg-accent-hover text-bg-base uppercase tracking-wider font-bold text-sm px-4 py-1.5 rounded hover:bg-accent disabled:opacity-40"
        >
          {saving ? "Saving…" : "Save"}
        </button>
        <button
